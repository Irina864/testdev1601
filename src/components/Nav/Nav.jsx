...
const Nav = ({
  ...
  return (
    <nav className={styles.nav}>
      ...
      isAboutCompany && isMobile && navigation.link.includes('chat') ? (
        <>
        ...
        isMobile &&
        !navigation.link.includes('chat') ? null : isAboutCompany ? (
        <>
          <Link className={`${styles.nav__item}`} href={navigation.link}>
            {/* {navigation.title} */}
            Назад
          ...
          <div className={`${styles.nav__item} ${styles.page}`}>{page}</div>
        </> //! О вакансии из комании
      ) : isAboutCompanyVacancy &&
        isMobile &&
        navigation.link.includes('chat') ? (
        <>
          <Link className={`${styles.nav__item}`} href={navigation.link}>
            {/* {navigation.title} */}
            Чаты
        ...
        isMobile &&
        !navigation.link.includes('chat') ? null : isAboutCompanyVacancy ? (
        <>
          <Link className={`${styles.nav__item}`} href={navigation.link}>
            {/* {navigation.title} */}
            Назад
