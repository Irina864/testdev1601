    ...
    <div className={styles.container}>
      <div className={styles.wrap}>
        ...
        <FormSelect
          ...
          // className={`${
          //   periodErrors.start_month === 'startMonth' ? className : null
          // }`}
          className={`${periodErrors.start_month ? styles.errorInput : ''}`}
        />
        <FormSelect
          label="Год"
          array={years}
          ...
          // className={className}
          className={`${periodErrors.start_year ? styles.errorInput : ''}`}
        />
      </div>
      ...
      <div className={styles.wrap}>
        ...
        <FormSelect
          ...
          isNumber={true}
          // className={className}
          className={`${periodErrors.end_month ? styles.errorInput : ''}`}
        />
        <FormSelect
          label="Год"
          array={years}
          ...
          className={`${periodErrors.end_year ? styles.errorInput : ''}`}
        />
      </div>
    </div>
  );
