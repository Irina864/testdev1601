...
const BackButton = ({
  ...
  console.log("HELLO ")
  return (
    <div className={customClassName ? styles[customClassName] : styles.backButtonWrapper}>
      {linkToBack ? (
        ...
        >
          ...
          <span className={styles.span_currentSection}>{currentSection ? currentSection : nameLink}</span>
        </button>
      )}
    </div>
  );
